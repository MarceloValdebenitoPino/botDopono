...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "DoponoBot";
    public static final String TOKEN = "6873798682:AAGJDIdZo1QamXz72yEFxj7nxFgIGCOJU88";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_1_btn")) {
            ...
            sendTextMessageAsync(STEP_2_TEXT,
                    Map.of("¡Tomar una salchica! +20 de fama", "step_2_btn",
                            ...
                            "¡Tirar una alta de pepinillos! +20 de fama","step_2_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_2_btn")) {
            ...
            sendTextMessageAsync(STEP_3_TEXT,
                    Map.of("Hackea al robot aspirador","step_3_btn"));
        }
